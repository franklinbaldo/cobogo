...
Two materially different living consumers support the relation:
...
This remains enough for `experimental` under the current promotion gate, but not enough to standardize a component API. Future reviews should test whether archive/continuation and inscription remain useful in other living publication surfaces.
