...
O Astronauta entra com **20/24** depois da #42 permitir observar o admin real em leitura e escrita, desktop e celular, no commit que entrou em `main`. A nova observação confirmou a qualidade da composição densa no desktop e tornou visível um problema que os testes funcionais não mostravam: em `390×844`, `/types/Note` e `/concepts/edit/note-01` alargam o documento e exigem rolagem horizontal global. Isso mantém UI em 2/4 e UX em 3/4; a #43 registra o critério de correção.
