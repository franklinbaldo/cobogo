...
- `franklinbaldo/quem-sao-eles`, #25, incorporada como `4e412c8e4ae5b275dc9525dc97c9ecf066c8d384`: a correção tornou o rodapé independente de variáveis CSS ausentes. O Pages `33851656399` publicou esse mesmo commit e, somente depois disso, `PEP published capture` `33852287508` abriu diretamente `https://franklinbaldo.github.io/quem-sao-eles/pep/` em Chromium e produziu o pacote `9928944933`, identificado pelo commit publicado. Essa aplicação torna executável a distinção entre “o build passou” e “a página que o leitor recebeu passou”.
